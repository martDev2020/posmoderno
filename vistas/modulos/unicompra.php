        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" id="formUCom" autocomplete="nope">
                    ...
                    <div class="alert alert-danger alert-val alert-solid" role="alert" id="form-mensajeUCom">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" id="formUComE" autocomplete="nope">
                    <div class="ms-panel-body">
                        <div class="form-row">
                            <div class="col-md-6 mb-3" id="val-nombreUniE">
                                <label for="validationCustom11">Unidad</label>
                                <div class="input-group">
                                    <input type="hidden" id="idUCompraE" name="idUCompraE">
                                    <input type="text" class="form-control formulario_grupo-input" id="nombreUniE"
                                        onkeyup="mayusP(this);" placeholder="Unidad compra" name="nombreUniE"
                                        autocomplete="off">
                                    <i class="formulario_validacion-estado fas fa-times-circle"></i>
                                </div>
                                <div class="alert alert-success alert-val alert-solid" role="alert">
                    ...
                    <div class="d-flex justify-content-between">
                        <button type="submit" class="btn btn-light" data-dismiss="modal">Cancelar</button>
                        <button type="submit" id="editarUC" class="btn btn-primary shadow-none">Guardar</button>
